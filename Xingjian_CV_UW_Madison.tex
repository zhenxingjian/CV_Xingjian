...
%                \textbf{Title:} Research Intern
                \begin{itemize}\itemsep -2.2pt %reduce space between items
                 ...
                 \item[-] Published paper [4] with oral presentation in CVPR 2020 ($5.7\%$ acceptance rate)
                 \end{itemize}
...
\section{RESEARCH \\ EXPERIENCES}
                ...
                \begin{itemize}\itemsep -2.2pt %reduce space between items
                 ...
                 \item[-] Published paper [2] with oral presentation in CVPR 2021 ($4.6\%$ acceptance rate)
                 \end{itemize}
...
%                 In reality, this can save scanning time from $35$ mins to $7-9$ mins
				\item[-] Published paper [3] in AAAI 2021 ($21\%$ acceptance rate)
                 \end{itemize}
...
%                 \end{itemize}
                ...
                \begin{itemize}\itemsep -2.2pt %reduce space between items
                 ...
                 \item[-] Published paper [5] in ICCV 2019 ($25\%$ acceptance rate), and also extended to [1][6]
                 \end{itemize}
                ...
                \begin{itemize}\itemsep -2.2pt %reduce space between items
                 ...
                 \item[-] Published paper [7] in NeurIPS 2018 ($21\%$ acceptance rate)
                 \end{itemize}
