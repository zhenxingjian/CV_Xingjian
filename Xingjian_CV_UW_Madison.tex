...
\section{INTERN \\ EXPERIENCE}
                ...
                {\it Applied Scientist Intern}, AWS AI\\
...
%                \textbf{Title:} Applied Scientist Intern
                ...
                \item[-] In the small in-house dataset, our method improved 6\% from the current SOTA, while in the entire dataset, the F1 score is 0.5\% better
                \item[-] In the MS-COCO dataset for object detection, our method beats Deformable DETR on small dataset by 4\%
                 \end{itemize}
...
%                \textbf{Title:} Applied Scientist Intern
                ...
                \item[-] Got $1\%$ better accuracy, $7\%$ better textual explanation CIDEr, $2\%$ better visual explanation IoU
                 ...
                 \item[-] Published paper [1] in NAACL-MAI-Workshop 2021, together with oral presentation internally
                 \end{itemize}
...
%                \textbf{Title:} Research Intern
                \begin{itemize}\itemsep -2.2pt %reduce space between items
                 ...
                 \item[-] Published paper [5] with oral presentation in CVPR 2020 ($5.7\%$ acceptance rate)
                 \end{itemize}
...
\section{RESEARCH \\ EXPERIENCES}
                ...
                \begin{itemize}\itemsep -2.2pt %reduce space between items
                 ...
                 \item[-] Published paper [3] with oral presentation in CVPR 2021 ($4.6\%$ acceptance rate)
                 \end{itemize}
...
%                 In reality, this can save scanning time from $35$ mins to $7-9$ mins
				\item[-] Published paper [4] in AAAI 2021 ($21\%$ acceptance rate)
                 \end{itemize}
...
%                 \end{itemize}
                ...
                \begin{itemize}\itemsep -2.2pt %reduce space between items
                 ...
                 \item[-] Published paper [6] in ICCV 2019 ($25\%$ acceptance rate), and also extended to [2][7]
                 \end{itemize}
