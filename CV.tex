...
\section{Paper}
                ...
                \item Liu Yang, \textbf{Xingjian Zhen$^*$}, Rudrasis Chakraborty$^*$, Vikas Singh. ``ManifoldGLOW: Extending Flow-based Generative Models to Manifolds.'' \emph{In submission} 
...
\section{RESEARCH \\ EXPERIENCES}
                \textbf{Flow-based generative model for non-Euclidean data, manifold}\hfill 03/2019-09/2019
                ...
                \begin{itemize}\itemsep -2.2pt %reduce space between items
                 ...
                 \item Extracted voxels along each fiber bundles in DTI to fit the sequential model
